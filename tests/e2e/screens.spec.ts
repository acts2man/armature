...
const STAFF_ROUTES = ["/", "/projects", "/fleet", "/sites/new", "/agency/requests", "/agency/clients", "/agency/settings", "/agency/team", "/agency/help", "/account", "/github/setup", `/sites/${SITE_ID}`, `/sites/${SITE_ID}/pages`, `/sites/${SITE_ID}/pages?view=trash`, `/sites/${SITE_ID}/media`, `/sites/${SITE_ID}/contact`, `/sites/${SITE_ID}/contact?tab=settings`, `/sites/${SITE_ID}/appearance`, `/sites/${SITE_ID}/appearance/header`, `/sites/${SITE_ID}/appearance/footer`, `/sites/${SITE_ID}/appearance/menus`, `/sites/${SITE_ID}/pages/home`, `/sites/${SITE_ID}/pages/shared`, `/sites/${SITE_ID}/requests`, `/sites/${SITE_ID}/requests/new`, `/sites/${SITE_ID}/users`, `/sites/${SITE_ID}/team`, `/sites/${SITE_ID}/history`, `/sites/${SITE_ID}/settings`, `/sites/${SITE_ID}/settings/services`, `/sites/${SITE_ID}/settings/editing`, `/sites/${SITE_ID}/settings/history`, `/sites/${SITE_ID}/nothing-here`, "/nothing-here"];
const CLIENT_ROUTES = ["/", "/account", "/help", `/sites/${SITE_ID}`, `/sites/${SITE_ID}/pages`, `/sites/${SITE_ID}/media`, `/sites/${SITE_ID}/contact`, `/sites/${SITE_ID}/contact?tab=settings`, `/sites/${SITE_ID}/appearance`, `/sites/${SITE_ID}/appearance/menus`, `/sites/${SITE_ID}/pages/home`, `/sites/${SITE_ID}/requests`, `/sites/${SITE_ID}/requests/new`, `/sites/${SITE_ID}/users`, `/sites/${SITE_ID}/team`, `/sites/${SITE_ID}/history`, `/sites/${SITE_ID}/settings`, "/projects", "/fleet", "/github/setup", "/agency/clients"];
const WIDTHS = [
